...
public:
    ...
    void retranslateUi(QDialog *QGCMapRCToParamDialog)
    {
        ...
        rcParamChannelInfoLabel->setText(QApplication::translate("QGCMapRCToParamDialog", "Parameter Tuning ID", 0));
        ...
        scaleInfoLabel->setText(QApplication::translate("QGCMapRCToParamDialog", "Scale (keep default)", 0));
        value0InfoLabel->setText(QApplication::translate("QGCMapRCToParamDialog", "Center value", 0));
        ...
        label2->setText(QApplication::translate("QGCMapRCToParamDialog", "Tuning IDs can be mapped to channels in the RC settings", 0));
    } // retranslateUi
